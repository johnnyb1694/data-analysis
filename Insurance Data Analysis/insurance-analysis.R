...
ins_by_region %<>%
  mutate(avg_severity_eb = (n_severe + alpha0) / (n_region + alpha0 + beta0),
...
ins_by_region %>%
  ...
  labs(x = "Average incidence of large loss claims",
       ...
       subtitle = "The dotted curve refers to the prior distribution of the incidence of large loss claims",
